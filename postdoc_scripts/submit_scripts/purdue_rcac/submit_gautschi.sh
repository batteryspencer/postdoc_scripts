...
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=192  # max: 192
##SBATCH --tasks-per-node=128  # max: 128
##SBATCH --cpus-per-task=1
##SBATCH --mem=384G  # max: 384 GB
#SBATCH --partition=cpu
#SBATCH --qos=standby
#SBATCH -A jgreeley
#SBATCH --time=04:00:00  # max: (04:00:00 for standby, 14-00:00:00 for jgreeley)
...
BAD_NODE_LOG="/scratch/gautschi/pasumarv/bad_nodes.log"
